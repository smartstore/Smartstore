...
namespace Smartstore
{
    public static class DateTimeExtensions
    {
        ...
        {
            Localizer T = EngineContext.Current.ResolveService<IText>().Get;
            ...
            if (delta > 0)
            {
                ...
                {
                    result = T("Time.MinutesAgo", ts.Minutes);
                }
            ...
            else
            {
                ...
                {
                    tmp1 = EngineContext.Current.ResolveService<IDateTimeHelper>().ConvertToUserTime(tmp1, DateTimeKind.Utc);
                }
                //default formatting
        ...
        public static string Prettify(this TimeSpan ts)
        {
            ...
            try
            {
                ...
                // TODO: (mh) (core) Can we work with $ here?
                if (remainder == 0)
                {
