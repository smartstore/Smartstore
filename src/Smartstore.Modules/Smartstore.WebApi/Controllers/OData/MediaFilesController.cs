...
namespace Smartstore.Web.Api.Controllers.OData
{
    ...
    /// <summary>
    /// The endpoint for operations on MediaFile entity. Returns type MediaFileInfo which wraps and enriches MediaFile.
    /// </summary>
    [ProducesResponseType(Status422UnprocessableEntity)]
    public class MediaFilesController : WebApiController<MediaFile>
    {
        private static readonly ODataValidationSettings _defaultValidationSettings = new()
        {
        ...
        public IActionResult Get(ODataQueryOptions<MediaFile> options)
        {
            try
            {
                var result = Apply(options, Entities.AsNoTracking(), _defaultValidationSettings);
        ...
        public async Task<IActionResult> GetFilesByIds([FromODataUri, Required] int[] ids)
        {
            ...
            {
                return Ok(Array.Empty<MediaFileInfo>().AsQueryable());
            }
        ...
        private IActionResult DeleteFile()
        {
