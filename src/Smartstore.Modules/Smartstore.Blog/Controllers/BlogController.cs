...
namespace Smartstore.Blog.Controllers
{
    public class BlogController : PublicController
    {
        ...
        private readonly Lazy<IActivityLogger> _activityLogger; // TODO: (mh) (core) Why lazy?
        private readonly Lazy<IMessageFactory> _messageFactory; // TODO: (mh) (core) Why lazy?
