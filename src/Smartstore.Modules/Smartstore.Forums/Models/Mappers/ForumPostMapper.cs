...
namespace Smartstore.Forums.Models.Mappers
{
    ...
    internal class ForumPostMapper : Mapper<ForumPost, PublicForumPostModel>
    {
        ...
        public override async Task MapAsync(ForumPost from, PublicForumPostModel to, dynamic parameters = null)
        {
            ...
            var largeAvatar = (bool)(parameters.LargeAvatar == true);
            ...
            to.ForumPostCount = from.Customer.GenericAttributes.Get<int>(ForumService.ForumPostCountKey);
            ...
            to.FormattedSignature = HtmlUtility.ConvertPlainTextToHtml(from.Customer.GenericAttributes.Get<string>(ForumService.SignatureKey).HtmlEncode());
