        ...
        public override void Up()
        {
            ...
            if (!Schema.Table(forumGroup).Exists())
            {
                Create.Table(forumGroup)
                    ...
                    .WithColumn(nameof(ForumGroup.Description)).AsMaxString().Nullable()
            ...
            if (!Schema.Table(forum).Exists())
            {
                Create.Table(forum)
                    ...
                    .WithColumn(nameof(Domain.Forum.Description)).AsMaxString().Nullable()
            ...
            if (!Schema.Table(forumPost).Exists())
            {
                Create.Table(forumPost)
                    ...
                    .WithColumn(nameof(ForumPost.CustomerId)).AsInt32().NotNullable()
                        .Indexed().ForeignKey(nameof(Customer), id)
                    .WithColumn(nameof(ForumPost.Text)).AsMaxString().NotNullable()
            ...
            if (!Schema.Table(privateMessage).Exists())
            {
                Create.Table(privateMessage)
                    ...
                    .WithColumn(nameof(PrivateMessage.Text)).AsMaxString().NotNullable()
