...
public class PaymentSource
{
    ...
    [JsonPropertyName("pay_upon_invoice")]
...
public class PaymentSourceApm
{
    ...
    [JsonPropertyName("bic")] // INFO: Snake case will transform it to b_i_c otherwise
    public string BIC;
}
...
public enum UserAction
{
    ...
    /// </summary>
    [JsonStringEnumMemberName("SUBSCRIBE_NOW")]
    SubscribeNow
}
...
public enum Intent
{
    ...
    [JsonStringEnumMemberName("AUTHORIZE")]
    Authorize
}
...
public enum ItemCategoryType
{
    ...
    [JsonStringEnumMemberName("PHYSICAL_GOODS")]
    PhysicalGoods,

    [JsonStringEnumMemberName("DONATION")]
    Donation
}
