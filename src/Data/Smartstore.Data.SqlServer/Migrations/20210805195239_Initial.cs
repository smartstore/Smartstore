        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PaymentMethodSystemName = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserAgreementText = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalIdentifier = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    ExternalDisplayIdentifier = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    ...
                    ProviderSystemName = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentMethodSystemName = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    CustomerCurrencyCode = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    CurrencyRate = table.Column<decimal>(type: "decimal(18,8)", precision: 18, scale: 8, nullable: false),
                    VatNumber = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    ...
                    CheckoutAttributeDescription = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    CheckoutAttributesXml = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    CustomerLanguageId = table.Column<int>(type: "int", nullable: false),
                    AffiliateId = table.Column<int>(type: "int", nullable: false),
                    CustomerIp = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    AllowStoringCreditCardNumber = table.Column<bool>(type: "bit", nullable: false),
                    CardType = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    CardName = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    CardNumber = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    MaskedCreditCardNumber = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    CardCvv2 = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    CardExpirationMonth = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    CardExpirationYear = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    AllowStoringDirectDebit = table.Column<bool>(type: "bit", nullable: false),
                    DirectDebitAccountHolder = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    DirectDebitAccountNumber = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    DirectDebitBankCode = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    DirectDebitBankName = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    DirectDebitBIC = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    DirectDebitCountry = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    DirectDebitIban = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    CustomerOrderComment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthorizationTransactionId = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    AuthorizationTransactionCode = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    AuthorizationTransactionResult = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    CaptureTransactionId = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    CaptureTransactionResult = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    SubscriptionTransactionId = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    PurchaseOrderNumber = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    PaidDateUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ShippingMethod = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    ShippingRateComputationMethodSystemName = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    Deleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerComments = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
