...
namespace Smartstore
{
    ...
    public class SmartException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SmartException"/> class with serialized data.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SmartException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
        /// </summary>
