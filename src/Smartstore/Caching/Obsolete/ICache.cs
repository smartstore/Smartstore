...
//        T Get<T>(CacheKey key, bool independent = false);
...
//        T Get<T>(CacheKey key, Func<T> acquirer, TimeSpan? duration = null, bool independent = false, bool allowRecursion = false);
...
//        /// <param name="allowRecursion">When <c>false</c>, an exception will be thrown when the acquirer tries to acces the same cache item.</param>
//        /// <returns>Cached item value</returns>
//        Task<T> GetAsync<T>(CacheKey key, Func<Task<T>> acquirer, TimeSpan? duration = null, bool independent = false, bool allowRecursion = false);
...
//        /// <returns>Cached item value</returns>
//        ISet GetHashSet(CacheKey key, Func<IEnumerable<string>> acquirer = null);
...
//        /// </param>
//        void Put(CacheKey key, object value, TimeSpan? duration = null, IEnumerable<string> dependencies = null);
