...
{
    public class ProductAttributeOptionsSetMap : IEntityTypeConfiguration<ProductAttributeOptionsSet>
    {
    ...
    public partial class ProductAttributeOptionsSet : EntityWithAttributes, INamedEntity
    {
        ...
        {
            get => _lazyLoader?.Load(this, ref _productAttributeOptions) ?? (_productAttributeOptions ??= new HashSet<ProductAttributeOption>());
