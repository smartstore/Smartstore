...
namespace Smartstore.Core.Data.Migrations
{
    ...
    internal class PriceSettingsMigration : Migration, ILocaleResourcesProvider, IDataSeeder<SmartDbContext>
    {
        ...
        {
            builder.AddOrUpdate("Admin.Configuration.Settings.Price",
          "Prices",
          "Preise",
          "قیمت‌ها");
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.Price.DefaultComparePriceLabelId",
                ...
                "زمانی اعمال می‌شود که محصول برچسب \"قیمت مقایسه\" را تعریف نکرده باشد.");
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.Price.DefaultRegularPriceLabelId",
                ...
                "برچسب پیش‌فرض برای قیمت عادی خط‌خورده. زمانی اعمال می‌شود که پیشنهاد ویژه‌ای وجود داشته باشد یا تخفیفی به محصول اعمال شده باشد.");
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.Price.OfferPriceReplacesRegularPrice",
                ...
                "قیمت ویژه جایگزین قیمت عادی شود",
                ...
                "اگر فعال باشد، قیمت ویژه به جای قیمت عادی نمایش داده می‌شود، گویی هیچ پیشنهادی وجود ندارد. اگر غیرفعال باشد، قیمت عادی به صورت خط‌خورده نمایش داده می‌شود.");

            builder.AddOrUpdate("Admin.Configuration.Settings.Price.AlwaysDisplayRetailPrice",
                "Always display retail price",
                "UVP immer anzeigen",
                "همیشه قیمت خرده‌فروشی را نمایش بده",
                ...
                "اگر فعال باشد، قیمت پیشنهادی خرده‌فروشی (MSRP) در جزئیات محصول نمایش داده می‌شود، حتی اگر پیشنهاد یا تخفیفی وجود داشته باشد. " +
                "در این صورت، MSRP به عنوان یک قیمت خط‌خورده دیگر در کنار قیمت تخفیف‌خورده ظاهر می‌شود.");
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.Price.ShowOfferCountdownRemainingHours",
                ...
                "زمان باقی‌مانده (به ساعت) پیشنهاد را تنظیم می‌کند که از آن زمان شمارش معکوس در جزئیات محصول نمایش داده شود، مثلاً \"پایان در ۳ ساعت و ۲۳ دقیقه\". " +
                "برای مخفی کردن شمارش معکوس، چیزی وارد نکنید. " +
                "فقط برای پیشنهادهای محدود با تاریخ پایان اعمال می‌شود.");
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.Price.ShowOfferBadge",
                ...
                "در صورت فعال بودن قیمت تبلیغاتی، یک نشان نمایش می‌دهد.");
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.Price.OfferBadgeLabel",
                ...
                "متن نشان پیشنهاد، مثلاً \"پیشنهاد ویژه\"");
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.Price.LimitedOfferBadgeLabel",
                ...
                "متن نشان پیشنهاد در صورتی که پیشنهاد محدود باشد، مثلاً \"پیشنهاد محدود زمانی\"");
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.Price.ShowRetailPriceSaving",
                ...
                "نمایش صرفه‌جویی در قیمت نسبت به قیمت خرده‌فروشی",
                ...
                "مشخص می‌کند که آیا صرفه‌جویی در قیمت باید نمایش داده شود، حتی اگر تخفیف فقط به MSRP اعمال شده باشد.");
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.Price.ShowBasePriceInProductLists",
                ...
                "نمایش اطلاعات قیمت پایه در لیست محصولات",
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.Price.DisplayTextForZeroPrices",
                ...
                "نمایش متن وقتی قیمت‌ها ۰٫۰۰ است",
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.Price.IgnoreDiscounts",
                ...
                "Ignoriere Rabatte",
                "نادیده گرفتن تخفیف‌ها (در کل سایت)",
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.Price.ApplyPercentageDiscountOnTierPrice",
                ...
                "اعمال تخفیف‌های درصدی روی قیمت‌های پلکانی",
            ...
            builder.AddOrUpdate("Admin.Configuration.Settings.Price.ApplyTierPricePercentageToAttributePriceAdjustments",
                ...
                "اعمال درصد قیمت پلکانی روی تعدیل قیمت ویژگی‌ها",
                "Specifies whether to apply tier price percentage to attribute price adjustments.",
                "Bestimmt, ob prozentuale Ermäßigungen von Staffelpreisen auf Auf- & Abpreise von Attributen angewendet werden sollen",
                "مشخص می‌کند که آیا درصد قیمت پلکانی باید روی تعدیل قیمت ویژگی‌ها اعمال شود.");

            builder.AddOrUpdate("Admin.Configuration.Settings.Price.Display",
                "Display",
                "Darstellung",
                "نمایش");

            builder.AddOrUpdate("Admin.Configuration.Settings.Price.Baseprice",
                "Base prices",
                "Grundpreise",
                "قیمت‌های پایه");

            builder.AddOrUpdate("Admin.Configuration.Settings.Price.Discounts",
                "Discounts",
                "Rabatte",
                "تخفیف‌ها");

            builder.AddOrUpdate("Admin.Configuration.Settings.Price.DiscountDisplay",
                "Discount display",
                "Rabattdarstellung",
                "نمایش تخفیف");
            // Removed setting
