    ...
    public class DeDESeedData : InvariantSeedData
    {
        ...
        protected override void Alter(IList<ShippingMethod> entities)
        {
            ...
            entities.WithKey(x => x.DisplayOrder)
                ...
                .Alter(2, x => x.Name = "Kostenloser Versand");
        }
        ...
        protected override void Alter(IList<CustomerRole> entities)
        {
            ...
            entities.WithKey(x => x.Name)
               .Alter("Administrators", x => x.Name = "Administratoren")
               .Alter("Forum Moderators", x => x.Name = "Foren Moderatoren")
               .Alter("Registered", x => x.Name = "Registriert")
               .Alter("Guests", x => x.Name = "Gäste")
               .Alter("Inactive new customers", x => x.Name = "Inaktive Neukunden");
        }

        protected override void Alter(Address entity)
        {
            base.Alter(entity);
            var country = base.DbContext.Set<Country>().Where(x => x.ThreeLetterIsoCode == "DEU");
            ...
            entity.StateProvince = country.FirstOrDefault().StateProvinces.FirstOrDefault();
            entity.Country = country.FirstOrDefault();
        ...
        protected override void Alter(UrlRecord entity)
        {
            ...
            if (entity.EntityName == "Topic")
            {
                entity.Slug = entity.Slug switch
                {
                    ...
                    "shippinginfo" => "versand-und-rueckgabe",
                    "imprint" => "impressum",
        ...
        protected override void Alter(IList<ActivityLogType> entities)
        {
            ...
            entities.WithKey(x => x.SystemKeyword)
                .Alter("AddNewCategory", x => x.Name = "Erstellen einer Warengruppe")
                .Alter("AddNewCheckoutAttribute", x => x.Name = "Neues Checkout Attribut hinzugefügt")
                .Alter("AddNewCustomer", x => x.Name = "Neuen Kunden hinzugefügt")
                .Alter("AddNewCustomerRole", x => x.Name = "Neue Kundengruppe hinzugefügt")
                .Alter("AddNewDiscount", x => x.Name = "Neuer Rabatt hinzugefügt")
                .Alter("AddNewGiftCard", x => x.Name = "Neuer Geschenkgutschein hinzugefügt")
                .Alter("AddNewManufacturer", x => x.Name = "Neuer Hersteller hinzugefügt")
                .Alter("AddNewProduct", x => x.Name = "Neues Produkt hinzugefügt")
                .Alter("AddNewProductAttribute", x => x.Name = "Neues Produktattribut hinzugefügt")
                .Alter("AddNewSetting", x => x.Name = "Neue Einstellung hinzugefügt")
                .Alter("AddNewSpecAttribute", x => x.Name = "Neues Spezifikationsattribut hinzugefügt")
                .Alter("AddNewWidget", x => x.Name = "Neues Widget hinzugefügt")
                .Alter("DeleteCategory", x => x.Name = "Warengruppe gelöscht")
                .Alter("DeleteCheckoutAttribute", x => x.Name = "Checkout-Attribut gelöscht")
                .Alter("DeleteCustomer", x => x.Name = "Kunde gelöscht")
                .Alter("DeleteCustomerRole", x => x.Name = "Kundengruppe gelöscht")
                .Alter("DeleteDiscount", x => x.Name = "Rabatt gelöscht")
                .Alter("DeleteGiftCard", x => x.Name = "Geschenkgutschein gelöscht")
                .Alter("DeleteManufacturer", x => x.Name = "Hersteller gelöscht")
                .Alter("DeleteProduct", x => x.Name = "Produkt gelöscht")
                .Alter("DeleteProductAttribute", x => x.Name = "Produktattribut gelöscht")
                .Alter("DeleteReturnRequest", x => x.Name = "Rücksendeanforderung gelöscht")
                .Alter("DeleteSetting", x => x.Name = "Einstellung gelöscht")
                .Alter("DeleteSpecAttribute", x => x.Name = "Spezifikationsattribut gelöscht")
                .Alter("DeleteWidget", x => x.Name = "Widget gelöscht")
                .Alter("EditCategory", x => x.Name = "Warengruppe bearbeitet")
                .Alter("EditCheckoutAttribute", x => x.Name = "Checkout-Attribut bearbeitet")
                .Alter("EditCustomer", x => x.Name = "Kunde bearbeitet")
                .Alter("EditCustomerRole", x => x.Name = "Kundengruppe bearbeitet")
                .Alter("EditDiscount", x => x.Name = "Rabatt bearbeitet")
                .Alter("EditGiftCard", x => x.Name = "Geschenkgutschein bearbeitet")
                .Alter("EditManufacturer", x => x.Name = "Hersteller bearbeitet")
                .Alter("EditProduct", x => x.Name = "Produkt bearbeitet")
                .Alter("EditProductAttribute", x => x.Name = "Produktattribut bearbeitet")
                .Alter("EditPromotionProviders", x => x.Name = "Promotion-Provider bearbeiten")
                .Alter("EditReturnRequest", x => x.Name = "Rücksendewunsch bearbeitet")
                .Alter("EditSettings", x => x.Name = "Einstellungen bearbeitet")
                .Alter("EditSpecAttribute", x => x.Name = "Spezifikationsattribut bearbeitet")
                .Alter("EditWidget", x => x.Name = "Widget bearbeitet")
                .Alter("EditOrder", x => x.Name = "Auftrag bearbeitet")
                .Alter("PublicStore.ViewCategory", x => x.Name = "Öffentlicher Shop. Hat eine Warengruppen-Detailseite angesehen")
                ...
                .Alter("PublicStore.AddToWishlist", x => x.Name = "Öffentlicher Shop. Produkt zur Wunschliste hinzugefügt")
                .Alter("PublicStore.Login", x => x.Name = "Öffentlicher Shop. Anmeldung")
                .Alter("PublicStore.Logout", x => x.Name = "Öffentlicher Shop. Abmeldung")
        ...
        protected override void Alter(IList<SpecificationAttribute> entities)
        {
            ...
            entities.WithKey(x => x.DisplayOrder)
                .Alter(1, x => x.Name = "CPU-Hersteller")
                .Alter(2, x =>
                {
                    x.Name = "Farbe";
                ...
                .Alter(3, x => x.Name = "Festplatten-Kapazität")
                .Alter(4, x => x.Name = "Arbeitsspeicher")
                .Alter(5, x => x.Name = "Betriebssystem")
                .Alter(6, x => x.Name = "Anschluss")
                .Alter(7, x =>
                {
                    x.Name = "Geschlecht";
                ...
                .Alter(16, x => x.Name = "Massenspeicher-Typ")
                .Alter(17, x => x.Name = "Größe (externe HDD)")
                .Alter(18, x => x.Name = "MP3-Qualität")
                .Alter(19, x =>
                {
                    x.Name = "Genre";
                ...
                .Alter(23, x => x.Name = "Größe")
                .Alter(24, x => x.Name = "Durchmesser")
                .Alter(25, x =>
                {
                    x.Name = "Verschluss";
                ...
                .Alter(27, x => x.Name = "Speicherkapazität")
                .Alter(28, x =>
                {
        ...
        protected override void Alter(IList<ProductAttribute> entities)
        {
            ...
            entities.WithKey(x => x.Alias)
                .Alter("color", x => x.Name = "Farbe")
                .Alter("custom-text", x => x.Name = "Eigener Text")
                .Alter("hdd", x => x.Name = "HDD")
                .Alter("os", x => x.Name = "Betriebssystem")
                .Alter("processor", x => x.Name = "Prozessor")
                .Alter("ram", x => x.Name = "Arbeitsspeicher")
                .Alter("size", x => x.Name = "Größe")
                .Alter("software", x => x.Name = "Software")
                .Alter("game", x => x.Name = "Spiel")
                .Alter("iphone-color", x => x.Name = "Farbe")
                .Alter("ipad-color", x => x.Name = "Farbe")
                .Alter("memory-capacity", x => x.Name = "Speicherkapazität")
                .Alter("width", x => x.Name = "Weite")
                .Alter("length", x => x.Name = "Länge")
                .Alter("plate", x => x.Name = "Tischplatte")
                .Alter("plate-thickness", x => x.Name = "Stärke der Tischplatte")
                .Alter("ballsize", x => x.Name = "Ballgröße")
                .Alter("leather-color", x => x.Name = "Lederfarbe")
                .Alter("seat-shell", x => x.Name = "Sitzschale")
                .Alter("base", x => x.Name = "Fußgestell")
        ...
        protected override void Alter(IList<ProductTemplate> entities)
        {
            ...
            entities.WithKey(x => x.ViewPath)
                .Alter("Product", x => x.Name = "Standard Produkt Vorlage");
        }
        ...
        protected override void Alter(IList<CategoryTemplate> entities)
        {
            ...
            entities.WithKey(x => x.ViewPath)
                .Alter("CategoryTemplate.ProductsInGridOrLines", x => x.Name = "Products in Grid or Lines");
        }
        ...
        protected override void Alter(IList<ManufacturerTemplate> entities)
        {
            ...
            entities.WithKey(x => x.ViewPath)
                .Alter("ManufacturerTemplate.ProductsInGridOrLines", x => x.Name = "Products in Grid or Lines");
        }
        ...
        private static void AlterFurnitureProducts(IList<Product> entities)
        {
            entities.WithKey(x => x.Sku)
                ...
                .Alter("armchairs-sofas-group", x =>
                {
                    x.Name = "Sessel und Sofas";
                    x.MetaTitle = "Sessel und Sofas";
                    x.ShortDescription = "Entdecken Sie Komfort und Stil mit unserer exklusiven Auswahl an Sofas und Stühlen! Von eleganten Designs bis hin zu modernen Klassikern - unsere Möbelstücke werden Ihr Zuhause in eine Oase des Luxus verwandeln. Besuchen Sie uns heute und finden Sie die perfekten Stücke, um Ihren Wohnraum zu vervollständigen!";
                    x.FullDescription = "<p>Willkommen zu unserem exklusiven Möbelverkaufsevent! Tauchen Sie ein in den Komfort und die Eleganz unserer handverlesenen Kollektion von Sofas und Stühlen, die Ihr Zuhause in eine Oase des Luxus verwandeln werden.</p><p>Entdecken Sie die zeitlose Schönheit unserer Sofas, die nicht nur den Raum schmücken, sondern auch einladenden Sitzkomfort bieten. Von klassischen Designs bis hin zu modernen Stilen finden Sie bei uns das perfekte Sofa, das Ihre persönlichen Vorlieben und den Stil Ihres Wohnraums widerspiegelt. Jedes unserer Sofas ist meisterhaft gefertigt, um höchsten Ansprüchen an Qualität, Haltbarkeit und Stil gerecht zu werden.</p><p>Neben unseren luxuriösen Sofas bieten wir auch eine vielfältige Auswahl an Stühlen, die Funktionalität und Ästhetik perfekt vereinen. Egal, ob Sie nach eleganten Esszimmerstühlen für formelle Abendessen suchen oder nach gemütlichen Sesseln für entspannte Lesestunden - unsere Kollektion hat für jeden Geschmack und jeden Raum das Richtige.</p><p>Unsere Möbel sind nicht nur schön anzusehen, sondern auch praktisch im Alltag. Wir verwenden hochwertige Materialien und innovative Designs, um sicherzustellen, dass Ihre Möbelstücke nicht nur ästhetisch ansprechend, sondern auch langlebig und pflegeleicht sind.</p><p>Besuchen Sie uns noch heute und lassen Sie sich von unserer exquisiten Möbelkollektion inspirieren. Unser erfahrenes Team steht Ihnen gerne zur Verfügung, um Sie bei der Auswahl der perfekten Möbelstücke für Ihr Zuhause zu unterstützen. Machen Sie Ihr Zuhause zu einem Ort, an dem Komfort und Stil Hand in Hand gehen!</p>";
                });
        }
        ...
        protected override void Alter(IList<DeliveryTime> entities)
        {
            ...
            entities.WithKey(x => x.DisplayOrder)
                .Alter(0, x => x.Name = "sofort lieferbar")
                .Alter(1, x => x.Name = "2-5 Werktage")
                .Alter(2, x => x.Name = "7 Werktage");
        ...
        protected override void Alter(IList<ProductTag> entities)
        {
            ...
            entities.WithKey(x => x.Name)
                .Alter("gift", x => x.Name = "Geschenk")
                .Alter("book", x => x.Name = "Buch")
                .Alter("cooking", x => x.Name = "Kochen")
                .Alter("cars", x => x.Name = "Autos")
                .Alter("motorbikes", x => x.Name = "Motorräder")
                .Alter("download", x => x.Name = "Download")
                .Alter("watches", x => x.Name = "Uhren");
        }
        ...
        protected override void Alter(IList<RuleSetEntity> entities)
        {
            ...
            entities.WithKey(x => x.Name)
                .Alter("Weekends", x => x.Name = "Wochenenden")
