...
namespace Smartstore.Core.Installation
{
    public class DeDESeedData : InvariantSeedData
    {
        ...
        //    entities.WithKey(x => x.DisplayOrder)
        //        .Alter(1, x => x.Name = "Ausgezeichnet")
        //        .Alter(2, x => x.Name = "Gut")
        //        .Alter(3, x => x.Name = "Geht so")
        //        .Alter(4, x => x.Name = "Schlecht")
        //        .Alter(5, x => x.Name = "Täglich")
        //        .Alter(6, x => x.Name = "Wöchentlich")
        //        .Alter(7, x => x.Name = "Alle zwei Wochen")
        //        .Alter(8, x => x.Name = "Einmal im Monat");
        //}
