...
namespace Smartstore.Core.Installation
{
    public abstract partial class InvariantSeedData
    {
        ...
        private List<Product> GetProductsWithConditionalAttributes(
            Dictionary<string, Category> categories,
            Dictionary<string, Manufacturer> manufacturers)
        {
            var productTemplate = _db.ProductTemplates.First(x => x.ViewPath == "Product");
            var deliveryTime = _db.DeliveryTimes.FirstOrDefault();
            var taxCategory = _db.TaxCategories.FirstOrDefault(x => x.Name == TaxNameElectronics);

            var zippo = new Product
            {
                ProductType = ProductType.SimpleProduct,
                Sku = "zippo-1",
                Name = "Zippo lighter",
                ShortDescription = "Genuine Zippo lighter with optional engraving.",
                FullDescription = "<div>Zippo lighters are durable, refillable and built for a lifetime of use. Comes packaged in a gift box. For optimal performance, fill with Zippo lighter fuel.<ul><li>Genuine Zippo windproof lighter with distinctive Zippo \"click\"</li><li>All-metal construction; windproof design works virtually anywhere</li><li>Refillable for a lifetime of use; for optimal performance, we recommend genuine Zippo fuel, flints and wicks</li><li>Made in USA; Lifetime guarantee that \"it works or we fix it free\"</li><li>Fuel: Zippo lighter fuel (sold separately)</li></ul><div>Lighter Specs:</div><ul><li>Height: 2.25″</li><li>Width: 0.5″</li><li>Depth: 1.5″</li><li>Weight: 2.0 oz.</li></ul></div>",
                ProductTemplateId = productTemplate.Id,
                AllowCustomerReviews = true,
                Published = true,
                MetaTitle = "Zippo lighter",
                Price = 19.98m,
                ComparePrice = 49.90m,
            ...
            AddProductPicture(zippo, "product/zippo-lighter.jpg");
            zippo.ProductCategories.Add(new() { Category = categories["Sale"], DisplayOrder = 1 });
            


            var samsungS23 = new Product
            {
                ProductType = ProductType.SimpleProduct,
                Sku = "samsung-s23",
                Name = "Samsung Galaxy S23",
                ShortDescription = "Optionally with Samsung Watch",
                FullDescription = "<p>The Galaxy S23 series forms part of the flagship Samsung Galaxy S smartphone range, which breaks the rules of technology and innovation. You'll find next-level performance, pro-grade cameras and a wealth of customisable features across the three S23 models. In this guide, you'll discover more about each of the Galaxy S23 smartphones and how they compare to the latest Samsung phones in the Galaxy Z and A series.</p><p>The Galaxy S23 measures in at 6.1-inches and is the smallest in the Galaxy S23 series. Whilst it might be smaller than other S23 models it certainly packs a punch with a One UI 6 operating system and Qualcomm Snapdragon® 8 Gen 2 processor. Throw in a powerful 3,900mAh (typical) battery2 , 25W Super-Fast Charging3 capabilities and a new and improved cooling system4 and you have a powerhouse of a phone that stands up to the demands of your day. You'll find three pro-grade cameras on the rear that are optimised to capture Insta-worthy content whether you're at home or out and about. On the front, there's a 12MP wide-angle camera for taking selfies that are automatically optimised for your socials. And you can now get epic low-light portraits and self-portraits thanks to revolutionary upgrades in the camera technology⁴ that lets you capture more light, incredible colours and the finest of details even with the lights down low. What's more, it's now even easier to customise your Galaxy experience. From lock screen and wallpaper designs, to how the clock and notification bar appears, you can personalise your Galaxy S23 to suit your style, your way.</p><p>There's no doubt that the epic camera set-up found across the Galaxy S23 series sets it apart from its rivals. With a jaw-dropping resolution of 200MP on the Galaxy S23 Ultra camera and 50MP on the S23 and S23+, your photos will be bright and sharp, day or night. Throw in Optical and Space Zoom, plus AI-powered Nightography and you'll find that every shot is so epic, you'll constantly be asked \"Can you send me that?\". Capturing video? Digital image stabilisation and enhanced noise control will keep it super steady and buttery smooth. All combined, it means every shot boasts colour and detail that rivals even the best professional cameras.</p>",
                ProductTemplateId = productTemplate.Id,
                AllowCustomerReviews = true,
                Published = true,
                MetaTitle = "Samsung Galaxy S23",
                Price = 689.0m,
                ComparePrice = 899.0m,
                ManageInventoryMethod = ManageInventoryMethod.DontManageStock,
                OrderMinimumQuantity = 1,
            ...
            AddProductPicture(zippo, "product/samsung-galaxy-s23.jpg");
            AddProductPicture(zippo, "product/samsung-watch.jpg");
            samsungS23.ProductManufacturers.Add(new() { Manufacturer = manufacturers["Samsung"], DisplayOrder = 1, });

            return [zippo, samsungS23 ];
        }
