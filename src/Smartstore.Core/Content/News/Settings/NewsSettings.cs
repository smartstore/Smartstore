...
namespace Smartstore.Core.Content.News
{
    public class NewsSettings : ISettings
    {
        ...
        /// </summary>
        public bool ShowNewsOnMainPage { get; set; } = true;
        ...
        /// <summary>
        /// Gets or sets the meta title for news index page
        /// </summary>
        public string MetaTitle { get; set; }

        /// <summary>
        /// Gets or sets the meta description for news index page
        /// </summary>
        public string MetaDescription { get; set; }

        /// <summary>
        /// Gets or sets the meta keywords for news index page
        /// </summary>
