...
namespace Smartstore.Core.Checkout.Shipping.Extensions
{
    ...
    {
        /// <summary>
        /// Gets total width of <see cref="GetShippingOptionRequest.OrganizedItems"/>
        /// </summary>
        ...
        /// <summary>
        /// Gets total length of <see cref="GetShippingOptionRequest.OrganizedItems"/>
        /// </summary>
        ...
        /// <summary>
        /// Gets total height of <see cref="GetShippingOptionRequest.OrganizedItems"/>
        /// </summary>
