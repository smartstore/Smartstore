...
namespace Smartstore.Core.Checkout.Cart
{
    ...
    public interface IShoppingCartValidator
    {
        ...
        /// <param name="query"><see cref="ProductVariantQuery"/> to get selected checkout attributes from and to save it for <see cref="ShoppingCart.Customer"/>.</param>
        /// <param name="useRewardPoints">A value indicating whether to use reward points and to save it for <see cref="ShoppingCart.Customer"/>. <c>null</c> to ignore.</param>
