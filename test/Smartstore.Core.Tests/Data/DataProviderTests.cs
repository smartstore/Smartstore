...
namespace Smartstore.Core.Tests.Data
{
    ...
    public class DataProviderTests : ServiceTestBase
    {
        ...
        [TestCase("test_database-6.0.1.0-20210319100510-3.bak", true, 5, 1, 2021, 3, 19)]
        [TestCase("test_database-4.2.0.0-201905111020334-3.bak", true, 4, 2, 2019, 5, 11)]
        [TestCase("test_database-6.0.1.0-20220323102033", false, 5, 1, 2022, 3, 23)]
        [TestCase("test_database-6.0.1.0-20220323102033.log", false, 5, 1, 2022, 3, 23)]
