...
namespace Smartstore.Core.Tests
{
    ...
    public class ConversionTests
    {
        ...
        public void CanConvertEnumerables()
        {
            ...
            // INFO: (mh) (core) EnumerableConverter isn't available because it's internal now.
        ...
        public void CanConvertShippingOptions()
        {
            ...
            // TODO: (mh) (core) This fails with > Expected: instance of <Smartstore.Core.Checkout.Shipping.ShippingOption[]> But was:  null
